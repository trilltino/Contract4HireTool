...
#[doc=r#"The output of `C:\Users\isich\.rustup\toolchains\nightly-x86_64-pc-windows-msvc\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.84.0-nightly (da935398d 2024-10-19)";
#[doc=r#"The output of `C:\Users\isich\.rustup\toolchains\nightly-x86_64-pc-windows-msvc\bin\rustdoc.exe -V`; empty string if `C:\Users\isich\.rustup\toolchains\nightly-x86_64-pc-windows-msvc\bin\rustdoc.exe -V` failed to execute"#]
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.84.0-nightly (da935398d 2024-10-19)";
